        ...
        <div class="row">
          <div class="col-lg-11">
            <div class="p-5">
              ...
              <form class="user" method="POST" action="<?=base_url('admin/komisariat/update')?>">
                <?php foreach ($tampil as $t): ?>
                  <input type="hidden" name="id" value="<?=str_replace(['=','+','/'], ['-','_','~'], $this->encryption->encrypt($t->kodeKomisariat)) ?>">
                <div class="form-group mb-3">
                  ...
                  <input type="hidden" name="oldKodeKomisariat" value="<?=$t->kodeKomisariat ?>" readonly>
                </div>
                <div class="form-group mb-3">
