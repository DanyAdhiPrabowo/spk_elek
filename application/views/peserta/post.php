            ...
            <div class="p-5">
              ...
              <form class="user" method="POST" action="<?=base_url('admin/peserta/save')?>">
                ...
                <div class="form-group mb-3">
                  ...
                  <input type="text" class="form-control" placeholder="Masukkan NPM..." name="npm" value="<?=set_value('npm') ?>">
                  ...
                  <div class="col-md-12 ml-3">
                    <div class="form-check">
                      <label class="form-check-label">
                        <input class="form-check-input" type="radio" name="jk" id="Laki-Laki" value="l" <?=set_radio('jk', 'l', true) ?> >Laki-Laki
                      </label>
                    </div>
                    <div class="form-check">
                      <label class="form-check-label">
                        <input class="form-check-input" type="radio" name="jk" id="Perempuan" value="p" <?=set_radio('jk', 'p') ?> >Perempuan
                      </label>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-sm-6 ">
                    <div class="form-group mb-1">
                      ...
                      <div class="input-group"  style="width: 100%">
                        <input class="form-control" id="datepicker"  type="text" placeholder="Tanggal..." name="tgl" value="<?=set_value('tgl')?>" >
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control " id="exampleTextarea" rows="3" name="alamat"><?=set_value('alamat') ?></textarea>
                  ...
                  <div class="col-sm-6">
                    ...
                    <select class="form-control text-dark" name="komisariat">
                      ...
                      <?php foreach ($komisariat as $k): ?>
                        <option value="<?=$k->namaKomisariat ?>" <?=set_select('komisariat', $k->namaKomisariat)?> ><?=$k->namaKomisariat ?></option>
                      <?php endforeach; ?>
                    </select>
